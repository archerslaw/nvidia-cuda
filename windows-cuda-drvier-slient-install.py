...
echo "echo %date:~0,4%-%date:~5,2%-%date:~8,2%%time% Logs: Install nvidia cuda package.>>C:\Program Files\Cloudbase Solutions\Cloudbase-Init\LocalScripts\nvidia-install.cmd
...
echo "echo %date:~0,4%-%date:~5,2%-%date:~8,2%%time% Logs: Remove nvidia cuda and driver echo package.>>C:\Program Files\Cloudbase Solutions\Cloudbase-Init\LocalScripts\nvidia-install.cmd
echo "del /a/f >>C:\Program Files\Cloudbase Solutions\Cloudbase-Init\LocalScripts\nvidia-install.cmd
